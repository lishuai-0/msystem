package com.bug1024.msystem.utils.orm;

import com.bug1024.msystem.utils.pool.ConnectionPool;
...
//            }
    ...
    //方案二       MyBatis
    public Integer update(String sql,Object obj){//obj--->domain对象  Student
        int rows = 0;
        try {
    ...
    public Integer delete(String sql,Object obj){return this.update(sql,obj);}
